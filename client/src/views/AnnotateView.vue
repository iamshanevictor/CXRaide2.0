  ...
  <div class="annotate-container">
    ...
    <div v-else class="annotate-wrapper">
      ...
      <HeaderBar :username="username">
        <template #title>
          CXR Annotation :
          <span class="highlight">Lab ↔ AI Collaboration</span>
        </template>
      </HeaderBar>
            ...
            >
              <div class="summary-header" @click="toggleDetectionResults">
                ...
                <button class="toggle-btn">
                  <i :class="detectionResultsExpanded ? 'bi bi-chevron-up' : 'bi bi-chevron-down'"></i>
                </button>
              </div>
...
/* Update styles to account for layout changes */
.annotate-container {
  width: 100%;
}
...
/* Logo and navigation item styles moved to NavSidebar.vue component */

/* Annotate specific styles */
.annotate-wrapper {  flex: 1;  padding: 1.5rem;  /* Navigation margin handled in AppLayout now */  width: 100%;}
